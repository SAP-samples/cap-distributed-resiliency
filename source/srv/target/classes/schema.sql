...
CREATE TABLE API_BUSINESS_PARTNER_A_BPContactToAddress (
  ...
  to_EmailAddress_AddressID NVARCHAR(10),
  to_EmailAddress_Person NVARCHAR(10),
  to_EmailAddress_OrdinalNumber NVARCHAR(3),
  to_FaxNumber_AddressID NVARCHAR(10),
  to_FaxNumber_Person NVARCHAR(10),
  to_FaxNumber_OrdinalNumber NVARCHAR(3),
  to_MobilePhoneNumber_AddressID NVARCHAR(10),
  to_MobilePhoneNumber_Person NVARCHAR(10),
  to_MobilePhoneNumber_OrdinalNumber NVARCHAR(3),
  to_PhoneNumber_AddressID NVARCHAR(10),
  to_PhoneNumber_Person NVARCHAR(10),
  to_PhoneNumber_OrdinalNumber NVARCHAR(3),
  to_URLAddress_AddressID NVARCHAR(10),
  to_URLAddress_Person NVARCHAR(10),
  to_URLAddress_OrdinalNumber NVARCHAR(3),
  to_URLAddress_ValidityStartDate DATE,
...
CREATE TABLE API_BUSINESS_PARTNER_A_BusinessPartner (
  ...
  to_BuPaIdentification_BusinessPartner NVARCHAR(10),
  to_BuPaIdentification_BPIdentificationType NVARCHAR(6),
  to_BuPaIdentification_BPIdentificationNumber NVARCHAR(60),
  to_BuPaIndustry_IndustrySector NVARCHAR(10),
  to_BuPaIndustry_IndustrySystemType NVARCHAR(4),
  to_BuPaIndustry_BusinessPartner NVARCHAR(10),
  to_BusinessPartnerAddress_BusinessPartner NVARCHAR(10),
  to_BusinessPartnerAddress_AddressID NVARCHAR(10),
  to_BusinessPartnerBank_BusinessPartner NVARCHAR(10),
  to_BusinessPartnerBank_BankIdentification NVARCHAR(4),
  to_BusinessPartnerContact_RelationshipNumber NVARCHAR(12),
  to_BusinessPartnerContact_BusinessPartnerCompany NVARCHAR(10),
  to_BusinessPartnerContact_BusinessPartnerPerson NVARCHAR(10),
  to_BusinessPartnerContact_ValidityEndDate DATE,
  to_BusinessPartnerRole_BusinessPartner NVARCHAR(10),
  to_BusinessPartnerRole_BusinessPartnerRole NVARCHAR(6),
  to_BusinessPartnerTax_BusinessPartner NVARCHAR(10),
  to_BusinessPartnerTax_BPTaxType NVARCHAR(4),
  to_Customer_Customer NVARCHAR(10),
  to_Supplier_Supplier NVARCHAR(10),
...
CREATE TABLE API_BUSINESS_PARTNER_A_BusinessPartnerAddress (
  ...
  to_AddressUsage_BusinessPartner NVARCHAR(10),
  to_AddressUsage_ValidityEndDate TIMESTAMP,
  to_AddressUsage_AddressUsage NVARCHAR(10),
  to_AddressUsage_AddressID NVARCHAR(10),
  to_EmailAddress_AddressID NVARCHAR(10),
  to_EmailAddress_Person NVARCHAR(10),
  to_EmailAddress_OrdinalNumber NVARCHAR(3),
  to_FaxNumber_AddressID NVARCHAR(10),
...
CREATE TABLE API_BUSINESS_PARTNER_A_BusinessPartnerContact (
  ...
  RelationshipCategory NVARCHAR(6),
  to_ContactAddress_RelationshipNumber NVARCHAR(12),
  to_ContactAddress_BusinessPartnerCompany NVARCHAR(10),
  to_ContactAddress_BusinessPartnerPerson NVARCHAR(10),
  to_ContactAddress_ValidityEndDate DATE,
  to_ContactAddress_AddressID NVARCHAR(10),
  to_ContactRelationship_RelationshipNumber NVARCHAR(12),
  to_ContactRelationship_BusinessPartnerCompany NVARCHAR(10),
  to_ContactRelationship_BusinessPartnerPerson NVARCHAR(10),
  to_ContactRelationship_ValidityEndDate DATE,
  PRIMARY KEY(RelationshipNumber, BusinessPartnerCompany, BusinessPartnerPerson, ValidityEndDate)
);
...
CREATE TABLE API_BUSINESS_PARTNER_A_Customer (
  ...
  to_CustomerCompany_Customer NVARCHAR(10),
  to_CustomerCompany_CompanyCode NVARCHAR(4),
  to_CustomerSalesArea_Customer NVARCHAR(10),
  to_CustomerSalesArea_SalesOrganization NVARCHAR(4),
  to_CustomerSalesArea_DistributionChannel NVARCHAR(2),
  to_CustomerSalesArea_Division NVARCHAR(2),
...
CREATE TABLE API_BUSINESS_PARTNER_A_CustomerCompany (
  ...
  CustomerAccountGroup NVARCHAR(4),
  to_CustomerDunning_Customer NVARCHAR(10),
  to_CustomerDunning_CompanyCode NVARCHAR(4),
  to_CustomerDunning_DunningArea NVARCHAR(2),
  to_WithHoldingTax_Customer NVARCHAR(10),
  to_WithHoldingTax_CompanyCode NVARCHAR(4),
  to_WithHoldingTax_WithholdingTaxType NVARCHAR(2),
...
CREATE TABLE API_BUSINESS_PARTNER_A_CustomerSalesArea (
  ...
  CustomerAccountGroup NVARCHAR(4),
  to_PartnerFunction_Customer NVARCHAR(10),
  to_PartnerFunction_SalesOrganization NVARCHAR(4),
  to_PartnerFunction_DistributionChannel NVARCHAR(2),
  to_PartnerFunction_Division NVARCHAR(2),
  to_PartnerFunction_PartnerCounter NVARCHAR(3),
  to_PartnerFunction_PartnerFunction NVARCHAR(2),
  to_SalesAreaTax_Customer NVARCHAR(10),
  to_SalesAreaTax_SalesOrganization NVARCHAR(4),
  to_SalesAreaTax_DistributionChannel NVARCHAR(2),
  to_SalesAreaTax_Division NVARCHAR(2),
  to_SalesAreaTax_DepartureCountry NVARCHAR(3),
  to_SalesAreaTax_CustomerTaxCategory NVARCHAR(4),
...
CREATE TABLE API_BUSINESS_PARTNER_A_Supplier (
  ...
  to_SupplierCompany_Supplier NVARCHAR(10),
  to_SupplierCompany_CompanyCode NVARCHAR(4),
  to_SupplierPurchasingOrg_Supplier NVARCHAR(10),
  to_SupplierPurchasingOrg_PurchasingOrganization NVARCHAR(4),
...
CREATE TABLE API_BUSINESS_PARTNER_A_SupplierCompany (
  ...
  SupplierAccountGroup NVARCHAR(4),
  to_SupplierDunning_Supplier NVARCHAR(10),
  to_SupplierDunning_CompanyCode NVARCHAR(4),
  to_SupplierDunning_DunningArea NVARCHAR(2),
  to_SupplierWithHoldingTax_Supplier NVARCHAR(10),
  to_SupplierWithHoldingTax_CompanyCode NVARCHAR(4),
  to_SupplierWithHoldingTax_WithholdingTaxType NVARCHAR(2),
...
CREATE TABLE API_BUSINESS_PARTNER_A_SupplierPurchasingOrg (
  ...
  AuthorizationGroup NVARCHAR(4),
  SupplierAccountGroup NVARCHAR(4),
  to_PartnerFunction_Supplier NVARCHAR(10),
  to_PartnerFunction_PurchasingOrganization NVARCHAR(4),
  to_PartnerFunction_SupplierSubrange NVARCHAR(6),
  to_PartnerFunction_Plant NVARCHAR(4),
  to_PartnerFunction_PartnerFunction NVARCHAR(2),
  to_PartnerFunction_PartnerCounter NVARCHAR(3),
