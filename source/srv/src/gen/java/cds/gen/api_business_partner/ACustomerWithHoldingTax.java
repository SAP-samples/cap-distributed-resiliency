...
public interface ACustomerWithHoldingTax extends CdsData {
  ...
  String WITHHOLDING_TAX_AGENT = "WithholdingTaxAgent";

  String OBLIGATION_DATE_BEGIN = "ObligationDateBegin";

  String OBLIGATION_DATE_END = "ObligationDateEnd";
  ...
  @CdsName(WITHHOLDING_TAX_AGENT)
  Boolean getWithholdingTaxAgent();

  @CdsName(WITHHOLDING_TAX_AGENT)
  void setWithholdingTaxAgent(Boolean withholdingTaxAgent);

  @CdsName(OBLIGATION_DATE_BEGIN)
  LocalDate getObligationDateBegin();

  @CdsName(OBLIGATION_DATE_BEGIN)
  void setObligationDateBegin(LocalDate obligationDateBegin);

  @CdsName(OBLIGATION_DATE_END)
  LocalDate getObligationDateEnd();

  @CdsName(OBLIGATION_DATE_END)
  void setObligationDateEnd(LocalDate obligationDateEnd);
  ...
  ACustomerWithHoldingTax_ ref();

  static ACustomerWithHoldingTax create() {
    return Struct.create(ACustomerWithHoldingTax.class);
  }
}
