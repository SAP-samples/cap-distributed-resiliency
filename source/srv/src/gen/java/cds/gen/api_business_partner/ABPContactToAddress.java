...
public interface ABPContactToAddress extends CdsData {
  ...
  ABPContactToAddress_ ref();

  static ABPContactToAddress create() {
    return Struct.create(ABPContactToAddress.class);
  }
}
