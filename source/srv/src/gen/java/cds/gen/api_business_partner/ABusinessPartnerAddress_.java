...
public interface ABusinessPartnerAddress_ extends StructuredType<ABusinessPartnerAddress_> {
  String CDS_NAME = "API_BUSINESS_PARTNER.A_BusinessPartnerAddress";
  ...
  ElementRef<String> AddressIDByExternalSystem();

  ABuPaAddressUsage_ to_AddressUsage();

  ABuPaAddressUsage_ to_AddressUsage(Function<ABuPaAddressUsage_, CqnPredicate> filter);

  ElementRef<String> to_AddressUsage_BusinessPartner();

  ElementRef<Instant> to_AddressUsage_ValidityEndDate();

  ElementRef<String> to_AddressUsage_AddressUsage();

  ElementRef<String> to_AddressUsage_AddressID();
